...
class AlpsTreeNode : public AlpsKnowledge { //Why don't need head file??
 ...
 public:
   ...
   AlpsKnowledgeBroker*  getKnowledgeBroker() { return knowledgeBroker_; }
   void setKnowledgeBroker(AlpsKnowledgeBroker* kb) { knowledgeBroker_ = kb; }
...
class AlpsNodePool : public AlpsKnowledgePool {
 ...
 public:
   ...
   virtual int getNumKnowledges() const { return candidateList_.size(); }

   virtual bool hasKnowledge() const{ return !empty(); }

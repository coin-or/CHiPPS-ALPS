...
static Alps_message us_english[] =
{
    ...
    {ALPS_LOADBAL_HUB_PERIOD, 7, 3, "Hub[%d] balances its workers every %.4f seconds"},
    {ALPS_LOADBAL_MASTER, 8, 3, "Master[%d] balanced workloads of the hubs %d times"},
    {ALPS_LOADBAL_MASTER_NO, 9, 3, "Master[%d] balanced workload but do nothing since work load is %g"},
    {ALPS_LOADBAL_MASTER_PERIOD, 11, 3, "Master[%d] balances the hubs every %.4f seconds"},
    {ALPS_LOADBAL_WORKER_ASK, 12, 3, "Worker[%d] asks its hub (%d) for work"},
    {ALPS_LOADREPORT_MASTER, 111, 1, "Nodes(processed %d, left %g), msg counts(sent %d, received %d), incumbent %g, time %.2f"},
    {ALPS_LOADREPORT_MASTER_F, 112, 1, "Nodes(processed %d, left %g / %g), msg counts(sent %d, received %d), incumbent %g, time %.2f"},
    {ALPS_LOADREPORT_MASTER_N, 115, 1, "Nodes(processed %d, left %g), msg counts(sent %d, received %d), no solution, time %.2f"},
    {ALPS_LOADREPORT_MASTER_F_N, 116, 1, "Nodes(processed %d, left %g / %g), msg counts(sent %d, received %d), no solution, time %.2f"},

...
static Alps_message us_english[] =
{
    ...
    {ALPS_LOADREPORT_MASTER, 90, 1, "Node %d: left %g, msg(sent %d, received %d), inter %d, incumbent %g, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F, 92, 1, "Node %d: left(%g / %g), msg(sent %d, received %d), inter %d, incumbent %g, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_N, 94, 1, "Node %d: left %g, msg(sent %d, received %d), inter %d, no solution, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F_N, 96, 1, "Node %d: left(%g / %g), msg(sent %d, received %d), inter %d, no solution, wallclock %.0f sec."},
    ...
    {ALPS_RAMPUP_HUB_RECV, 134, 3, "Hub[%d] received all subtrees (nodes) sent by the master(%d)"},
    ...
    {ALPS_RAMPUP_MASTER_SOL, 144, 2, "Master[%d] found a better solution %g during rampup"},
    {ALPS_RAMPUP_MASTER_START, 146, 1, "Master[%d] is creating nodes (%d) for its hubs during rampup"},
    ...
    {ALPS_TERM_FORCE_NODE, 170, 1, "Master asked other processes to exit due to reaching node limt %d"},
    {ALPS_TERM_FORCE_TIME, 172, 1, "Master asked other processes to exit due to reaching time limt %.2f seconds"},

...
static Alps_message us_english[] =
{
    ...
    {ALPS_LOADREPORT_MASTER, 90, 1, "Node %d: left %g, msg(sent %d, recv %d), inter(%d, %g), incumbent %g, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F, 92, 1, "Node %d: left(%g / %g), msg(sent %d, recv %d), inter %d, incumbent %g, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_N, 94, 1, "Node %d: left %g, msg(sent %d, recv %d), inter(%d, %g), no solution, wallclock %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F_N, 96, 1, "Node %d: left(%g / %g), msg(sent %d, recv %d), inter %d, no solution, wallclock %.0f sec."},

...
static Alps_message us_english[] =
{
    ...
    {ALPS_LOADBAL_HUB_PERIOD, 7, 1, "Hub[%d] initially balances its workers every %.4f seconds"},
    ...
    {ALPS_LOADREPORT_MASTER, 111, 1, "Node %d: left %g, msg(sent %d, received %d), inter %d, incumbent %g, time %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F, 112, 1, "Node %d: left(%g / %g), msg(sent %d, received %d), inter %d, incumbent %g, time %.0f sec."},
    {ALPS_LOADREPORT_MASTER_N, 115, 1, "Node %d: left %g, msg(sent %d, received %d), inter %d, no solution, time %.0f"},
    {ALPS_LOADREPORT_MASTER_F_N, 116, 1, "Node %d: left(%g / %g), msg(sent %d, received %d), inter %d, no solution, time %.0f sec."},

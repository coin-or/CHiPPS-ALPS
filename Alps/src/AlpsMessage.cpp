...
static Alps_message us_english[] =
{
    ...
    {ALPS_LOADBAL_HUB_PERIOD, 7, 1, "Hub[%d] balanced its workers every %.4f seconds"},
    ...
    {ALPS_LOADBAL_MASTER_PERIOD, 11, 1, "Master[%d] balances the hubs every %.4f seconds"},
    {ALPS_LOADBAL_WORKER_ASK, 12, 3, "Worker[%d] asks its hub (%d) for work"},
    {ALPS_LOADREPORT_MASTER, 111, 1, "Nodes(processed %d, left %g), msg(sent %d, received %d), inter %d, incumbent %g, time %.0f sec."},
    {ALPS_LOADREPORT_MASTER_F, 112, 1, "Nodes(processed %d, left %g / %g), msg(sent %d, received %d), inter %d, incumbent %g, time %.0f sec."},
    {ALPS_LOADREPORT_MASTER_N, 115, 1, "Nodes(processed %d, left %g), msg(sent %d, received %d), inter %d, no solution, time %.0f"},
    {ALPS_LOADREPORT_MASTER_F_N, 116, 1, "Nodes(processed %d, left %g / %g), msg(sent %d, received %d), inter %d, no solution, time %.0f sec."},

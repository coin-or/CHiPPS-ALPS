...
void AlpsOwnParams::createKeywordList() {
   ...
   //
   keys_.push_back(make_pair(AlpsString("Alps_needLoadThreshold"),
			     AlpsParameter(AlpsDoublePar, needLoadThreshold)));
   //
...
void AlpsOwnParams::setDefaultEntries() {
  //--------------------------------------------------------------------------
  // CharPar
